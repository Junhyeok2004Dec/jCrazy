...
public class Player extends Entity {
	...
	public BufferedImage up1, up2, down1, down2, right1, right2, left1, left2, idle1, idle2, heart, halfheart, bkh1,
			bkh2, bkh3;
	...
	public void draw(Graphics2D gp) {
		...
		text.setText(String.valueOf(this.hp), 500, 500);
		...
		if ((this.hp % 2) == 1) {
			gp.drawImage(halfheart, this.hp * this.gp.tileSize / 4 - 24, 0, this.gp.tileSize / 2, this.gp.tileSize / 2,
					null);
